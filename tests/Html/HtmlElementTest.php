...
class HtmlElementTest extends TestCase
{
    ...
    public function full_page()
    {
        ...
        AssertEquals::applyWith(
            ...
            "string",
            17.62, // 15.45, // 8.56, // 7.07, // 6.69, // 6.64, // 6.59, // 6.11, // 5.53, // 5.34, // 9.56 // 7.14 // 6.94
            1
        )->unfoldUsing(
            Html::html(
                  Html::head(
    ...
    public function all_passed_attributes_end_up_in_the_element()
    {
        AssertEquals::applyWith(
         ...
         AssertEquals::applyWith(
            ...
            "string",
            2.56, // 2.29, // 1.95, // 1.52, // 0.9, // 0.85, // 0.83, // 0.75, // 0.72, // 0.67, // 0.8 // 0.74 // 0.72 // 0.58 // 0.56 // 0.32 // 0.64 // 0.53 // 0.41
            1
        )->unfoldUsing(
