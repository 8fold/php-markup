...
class HtmlElementTest extends TestCase
{
    ...
    public function full_page()
    {
        ...
        AssertEquals::applyWith(
            ...
            "string",
            18.13, // 17.62, // 15.45, // 8.56, // 7.07, // 6.69, // 6.64, // 6.59, // 6.11, // 5.53, // 5.34, // 9.56 // 7.14 // 6.94
            1
        )->unfoldUsing(
            Html::html(
                  Html::head(
    ...
    public function child_elements_omitting_end_tag()
    {
        AssertEquals::applyWith(
            ...
            "string",
            12.75, // 12.57, // 9.17, // 5.34, // 4.11, // 3.51, // 3.01, // updated shoop 6.87 // 6.67 // 6.24
            1
        )->unfoldUsing(
            Html::object(
                Html::param()
        ...
        AssertEquals::applyWith(
            ...
            "string",
            8.63, // 8.37, // 4.93, // 4.86, // 4.73, // 4.01, // 3.14, // 2.84, // 5.24
            1
        )->unfoldUsing(
            Html::head(
                  Html::title('Hello, World!'),
    ...
    public function nested_elements_with_string()
    {
        AssertEquals::applyWith(
            ...
            "string",
            8.76, // 8.22, // 6.19, // 4.95, // 4.16, // 3.04, // 3, // 2.88, // 2.78, // 2.53, // updated shoop 7.24
            1
        )->unfoldUsing(
            Html::ul(
                Html::li(
        ...
        AssertEquals::applyWith(
            ...
            "string",
            3.75, // 3.32, // 1.76, // 1.6, // 1.56, // 1.21, // 1.13, // 0.97, // 0.87, // 2.37
            1
        )->unfoldUsing(
    ...
    public function all_passed_attributes_end_up_in_the_element()
    {
        AssertEquals::applyWith(
         ...
         AssertEquals::applyWith(
            ...
            "string",
            2.59, // 2.56, // 2.29, // 1.95, // 1.52, // 0.9, // 0.85, // 0.83, // 0.75, // 0.72, // 0.67, // 0.8 // 0.74 // 0.72 // 0.58 // 0.56 // 0.32 // 0.64 // 0.53 // 0.41
            1
        )->unfoldUsing(
