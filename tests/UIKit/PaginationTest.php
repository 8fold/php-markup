...
class PaginationTest extends TestCase
{
    public function testPagination()
    {
        ...
        // $this->assertEqualsWithPerformance(1, $paginator->currentPage()->unfold());
        // $this->assertEqualsWithPerformance(100, $paginator->totalItems()->unfold());
        // $this->assertEqualsWithPerformance("/feed/page", $paginator->linkPrefix()->unfold());
        // $this->assertEqualsWithPerformance(10, $paginator->totalItemsPerPage()->unfold());
        // $this->assertEqualsWithPerformance(5, $paginator->middleLimit()->unfold());
